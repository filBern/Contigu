...
namespace Contigu.Core
{
    ...
    {
        /// <summary>All 8 shapes in a fixed array — also reused by DeckManager.AddJoker to pick a uniformly random shape.</summary>
        public static readonly ShapeId[] ShapeOrder =
        {
            ShapeId.Single, ShapeId.DomH,
            ShapeId.TriL, ShapeId.TriIH,
